...
STD_RESIDUES_PROTENIX = (
    PRO_STD_RESIDUES_NATURAL | RNA_STD_RESIDUES_NATRUAL | DNA_STD_RESIDUES
)
...
# Put design residues after natural residues, because Protenix use the first ones
STD_RESIDUES = STD_RESIDUES_PROTENIX | PRO_DESIGN_RESIDUES | RNA_DESIGN_RESIDUES
DESIGN_RESIDUES = PRO_DESIGN_RESIDUES | RNA_DESIGN_RESIDUES
PRO_STD_RESIDUES = PRO_STD_RESIDUES_NATURAL | PRO_DESIGN_RESIDUES
RNA_STD_RESIDUES = RNA_STD_RESIDUES_NATRUAL | RNA_DESIGN_RESIDUES

# STD_RESIDUES_WITH_GAP: Used for MSA feature
GAP = {"-": 31}
STD_RESIDUES_WITH_GAP = (
    STD_RESIDUES_PROTENIX | GAP | PRO_DESIGN_RESIDUES | RNA_DESIGN_RESIDUES
)
...
ELEMS = dict(
    [(i, len(STD_RESIDUES_PROTENIX) + idx) for idx, i in enumerate(get_all_elems())]
)

RES_ATOMS_DICT = {
    "xpb": {"N": 0, "CA": 1, "C": 2, "O": 3, "OXT": 4},
